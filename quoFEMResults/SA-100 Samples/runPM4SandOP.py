...
def runPM4SandOP(inputList, CSR, maxStrain, sigmav, kAlpha):
    ...
    matInput = {'Dr': 0.65, 'G0': 600.0, 'hpo': 0.08, 'rho': 1.26, 'Patm': 101.3, 'h0': -1.0, 'emax': 0.800,
                'emin': 0.500, 'nb': 0.50, 'nd': 0.10, 'Ado': -1.0, 'zmax': -1.0, 'cz': 250.0, 'ce': -1.0,
                'phicv': 33.0,
    ...
    for key, value in inputList.items():
        ...
        if (sys.platform == 'win32'):
            ...
            args = r"C:\Users\adith\Downloads\quoFEM_Windows_Download\quoFEM_Windows_Download\applications\opensees\bin\opensees.exe  DSS_quad_DispControl2.tcl {:.3f} 1000 {:.3f} {:.1f} 0.5 {:.3f} "
        ...
        # p = Popen(command2Run .format(CSR, maxStrain, sigmav, kAlpha), stderr = err, shell = True)
            ...
            args = r"C:\Users\adith\Downloads\quoFEM_Windows_Download\quoFEM_Windows_Download\applications\opensees\bin\opensees.exe " + filename + " {:.3f} 1000 {:.3f} {:.1f} 0.5 {:.3f} "
